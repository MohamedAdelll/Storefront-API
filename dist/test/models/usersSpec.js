...
describe("Test User Model", function () {
    ...
    it("should have a remove method", function () {
        expect(users_model_1.default.Delete).toBeDefined();
    });
    it("create method should create a user", function () { return __awaiter(void 0, void 0, void 0, function () {
        var createdUser, username, fname, lname;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, users_model_1.default.Create(user)];
                case 1:
                    createdUser = _a.sent();
                    if (createdUser) {
                        username = createdUser.username, fname = createdUser.fname, lname = createdUser.lname;
                        expect(username).toBe(user.username);
                        expect(fname).toBe(user.fName);
                        expect(lname).toBe(user.lName);
                    }
                    return [4 /*yield*/, users_model_1.default.Delete(createdUser.id)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it("show method should return the correct users", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    createdUser = _a.sent();
                    return [4 /*yield*/, users_model_1.default.Show(createdUser.id)];
                case 2:
                    userFromDb = _a.sent();
    ...
    it("remove method should remove the user", function () { return __awaiter(void 0, void 0, void 0, function () {
        var createdUser, showDeletedUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, users_model_1.default.Create(user)];
                case 1:
